...
const Login = () => {
    ...
    const submitHandler=(e)=>{
        ...
        if (!isSignup){
                ...
                if(String(formData.password).length <= 0) return( setNameError('Password\'s is too weak! 😏 '))
                    ...
                    </Form.Group>
                    {
                        isSignup && (
                                <Form.Group controlId='phone' className="my-2">
                                        ...
                                        <Form.Control name="phone" type='text' placeholder='Enter phone no...'  required onChange={handleChange}></Form.Control>
                                </Form.Group>
                                )
                        }
